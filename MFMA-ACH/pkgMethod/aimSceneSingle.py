...
class SingleProblem(ea.Problem): # 继承Problem父类
    def __init__(self):
...
def conductSceneSingleOP():
    ...
    for index in range(slotNum):
        ...
        best_gen,best_call,best_ObjV,best_Engy,best_Phen = singleOP()
        ### important update
