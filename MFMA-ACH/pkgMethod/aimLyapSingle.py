...
class SingleProblemLyap(ea.Problem): # 继承Problem父类
...
def singleOPLyap(scene):
    ...
    """===============================实例化问题对象==========================="""
    problem = SingleProblemLyap(scene) # 生成问题对象
    """=================================种群设置==============================="""
    Encoding = 'RI'       # 编码方式
    NIND = popSize            # 种群规模
...
def conductLyapSingleOP():
    ...
    for index in range(slotNum):
        ...
        best_gen,best_call,best_ObjV,best_Engy,best_Phen = singleOPLyap(scene)
        ### important update
